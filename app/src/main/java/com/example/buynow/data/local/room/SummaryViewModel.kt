...
class SummaryViewModel(context: Context, private val itemDao: ItemDao, private val categoryDao: CategoryDao) : ViewModel() {
        ...
        val combinedData: LiveData<List<SummaryAdmin>> = MediatorLiveData<List<SummaryAdmin>>().apply {
            ...
            addSource(table1LiveData) { table1Entities ->
                var bitmap = BitmapFactory.decodeResource(context.resources, R.drawable.ic_admin_3)
            ...
            addSource(table2LiveData) { table2Entities ->
                var bitmap = BitmapFactory.decodeResource(context.resources, R.drawable.ic_admin_2)
