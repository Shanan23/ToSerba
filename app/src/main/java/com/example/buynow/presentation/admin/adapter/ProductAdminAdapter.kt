package com.example.buynow.presentation.admin.adapter
...
class ProductAdminAdapter(private val productList: ArrayList<ItemEntity>, context: Context) :
    RecyclerView.Adapter<ProductAdminAdapter.ViewHolder>(), Filterable {
